            ...
            <div class="article__inner">
                ...
                <div class="article__content">
                    ...
                    <aside class="aside-info">
                        ...
                        <a href='<?php echo $resault_info['cases_resault-info-link']['url'] ?>'
                            class="aside-info__link aside-info__link--small">
                ...
                <div class="article__content">
                    ...
                    <div class="article__bottom">
                        ...
                        <div class="article__user">
                            <img src="<?php echo $resault['cases_resault-client-avatar'] ?>" alt=""
                                class="article__user-avatar">
            ...
            <div class="article__inner">
                ...
                <div class="article__content">
                    ...
                    <aside class="cases-item__solution-top-aside-info aside-info">
                        ...
                        <?php endif ?>
                        <a href='<?php echo $solution_info_top['cases_solution-info-top-link']['url'] ?>'
                        ...
                        <?php
                            $solution_list = new WP_Query([
                                ...
                                'meta_query' => [
                                    ...
                                    [
                                        'key' => 'cases_list-check-case', // name of custom field
                            ...
                            <li class="article__list-number-item">
                                ...
                                <div class="article__slider slider-img">
                                    ...
                                    <div class="article__slider-item">
                                        <img class="article__slider-item-img"
                                            src="<?php echo $solution_item_img['full_image_url'] ?>" alt="">
                    ...
                    <aside class="cases-item__solution-bottom-aside-info aside-info">
                        ...
                        <?php endif ?>
                        <a href='<?php echo $solution_info_bottom['cases_solution-info-bottom-link']['url'] ?>'
                            class="aside-info__link">
